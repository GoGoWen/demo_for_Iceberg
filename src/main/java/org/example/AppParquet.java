 ...
 * step 2: insert data with the init schema with Parquet format
 ...
 */
public class AppParquet
{
    public static final String wareHouseLocation = "/Users/yangbowen22/work/iceberg/warehouse/parquet/"+UUID.randomUUID().toString();
    ...
    public static final String strTable = "bowen";
